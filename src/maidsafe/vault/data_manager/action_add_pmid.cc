...
#include "maidsafe/vault/maid_manager/action_add_pmid.h"

#include "maidsafe/common/error.h"

#include "maidsafe/vault/maid_manager/action_add_pmid.pb.h"
...
const nfs::MessageAction ActionDataManagerAddPmid::kActionId;

ActionDataManagerAddPmid::ActionDataManagerAddPmid(const PmidName& pmid_name) : kPmidName(pmid_name) {}
