...
StructuredDataUnresolvedEntry::UnresolvedElement(const serialised_type& serialised_copy)
  ...
  unresolved_entry_key.second = static_cast<nfs::MessageAction>(proto_copy.key().action());
  if (!(unresolved_entry_key.second == nfs::MessageAction::kAccountTransfer ||
        unresolved_entry_key.second == nfs::MessageAction::kDelete ||
        unresolved_entry_key.second == nfs::MessageAction::kDeleteBranchUntilFork ||
        unresolved_entry_key.second == nfs::MessageAction::kPut)) {
    ThrowError(CommonErrors::parsing_error);
  }
