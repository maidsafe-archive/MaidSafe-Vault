...
inline bool SenderInGroupForClientMaid(const nfs::Message& data_message,
...
void MetadataManagerService::ValidatePutSender(const nfs::Message& data_message) const {
...
void MetadataManagerService::ValidateGetSender(const nfs::Message& data_message) const {
...
void MetadataManagerService::ValidateDeleteSender(const nfs::Message& data_message) const {
  if (!SenderInGroupForClientMaid(data_message, routing_))
    ThrowError(VaultErrors::permission_denied);
...
void MetadataManagerService::ValidatePostSender(const nfs::Message& generic_message) const {
...
void MetadataManagerService::HandleGenericMessage(const nfs::Message& generic_message,
...
void MetadataManagerService::HandleNodeDown(const nfs::Message& /*generic_message*/) {
  try {
...
void MetadataManagerService::HandleNodeUp(const nfs::Message& /*generic_message*/) {
  //try {
...
bool MetadataManagerService::ThisVaultInGroupForData(const nfs::Message& data_message) const {
