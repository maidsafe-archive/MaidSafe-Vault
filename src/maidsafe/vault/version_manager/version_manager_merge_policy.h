...
#ifndef MAIDSAFE_VAULT_VERSION_MANAGER_STRUCTURED_DATA_MERGE_POLICY_H_
#define MAIDSAFE_VAULT_VERSION_MANAGER_STRUCTURED_DATA_MERGE_POLICY_H_
...
#endif  // MAIDSAFE_VAULT_VERSION_MANAGER_STRUCTURED_DATA_MERGE_POLICY_H_
