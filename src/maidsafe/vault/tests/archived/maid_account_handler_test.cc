...
//        db_(),
//        maid_account_handler_(db_, NodeId(RandomString(identity_size))) {}
...
//  nfs_vault::PmidRegistration GenerateRegistration(bool unregister) {
//    passport::Anmaid anmaid;
//    passport::Maid maid(anmaid);
//    passport::Pmid pmid(maid);
//    nfs_vault::PmidRegistration registration(maid, pmid, unregister);
//    return registration;
//  }
